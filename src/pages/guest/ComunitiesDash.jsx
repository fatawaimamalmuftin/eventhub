    ...
    <>
        ...
        <section className="grid grid-cols-4 gap-8 px-18">
            {ComDashCardHead.map((e,i)=>(
                <div key={i} className="flex flex-col w-full text-gray-500 text-2xl myBorder px-8 py-5 gap-2">
        ...
        <main className="grid grid-cols-[60%_40%] gap-8 px-18 py-10">
            <div>
                ...
                <div className="">
                    {Events.map((e,i)=>(
                        <div key={i} className="grid mt-5 grid-cols-[15%_80%] px-5 py-5 myBorder gap-5">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="h-2 rounded-full bg-gray-100">
                                    ...
                                    style={{
                                        width:`${(e.attendees / e.capacity) * 100}%`
                                    }}/>
                                </div>
            ...
            <div className="grid grid-rows-[30%_16%_18%] max-h-285 gap-5">
                ...
                <div className="myBorder flex flex-col gap-5">
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="ml-auto">48/100</div>
                    </div>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="ml-auto">55/80</div>
                    </div>
